...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    const upstream=await fetch(LUNARIST_REVOKE,{method:'POST',headers:{'content-type':'application/json','accept':'application/json','authorization':'Bearer '+token},body:JSON.stringify({supabase_access_token:token})});
