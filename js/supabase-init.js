...
(function () {
  ...
  const scripts=['supabase-app-wire.js','inventory-supabase.js','inventory-backup-import.js','inventory-owner-users.js','card-tracking-supabase.js','notifications-enhancement.js','profile-avatar.js','catalog-image-fix.js'];
  scripts.forEach(name=>{const s=document.createElement('script');s.src='./js/'+name;s.defer=true;document.head.appendChild(s);});
})();
