...
(function () {
  ...
  const scripts=['supabase-app-wire.js','inventory-supabase.js','inventory-tools-scope.js','inventory-owner-users.js','card-tracking-supabase.js','notifications-enhancement.js','profile-avatar.js','catalog-image-fix.js','lunarist-link.js'];
  scripts.forEach(name=>{const s=document.createElement('script');s.src='./js/'+name+'?v=1';s.defer=true;document.head.appendChild(s);});
})();
