...
(function () {
  ...
  const scripts=['supabase-app-wire.js','inventory-supabase.js','inventory-tools-scope.js','inventory-owner-users.js','card-tracking-supabase.js','notifications-enhancement.js','profile-avatar.js','catalog-image-fix.js','lunarist-integration.js'];
